<template>
  <n-space justify="space-evenly" class="gobang-info-display">
    <NAvatar
      class="gobang-avatar"
      :size="40"
      :src="user.avatar"
    ...
    <n-gradient-text class="gobang-rate" :size="22" type="warning">
      {{ rating }}{{ user.rate }}
    </n-gradient-text>
    <n-gradient-text :size="22" v-if="user.home">
...
export default {
  ...
  setup (props) {
    ...
    return {
      ...
      onReady, uploadAvatarFinish, updateAvatar, avatarModal, avatarHeaders
    }
  }
}
</script>
