<template>
  ...
  <n-space vertical>
    <n-descriptions>
      <n-descriptions-item>
        <template #label> &nbsp;&nbsp;&nbsp;&nbsp;答案坐标: </template>
        <n-space justify="center">
          <n-input v-model:value="x" placeholder="横坐标x : [0~11]" />
          <n-input v-model:value="y" placeholder="纵坐标y : [0~11]" />
        </n-space>
      </n-descriptions-item>
    </n-descriptions>
    ...
    <n-descriptions>
      <n-descriptions-item>
        <template #label> &nbsp;&nbsp;&nbsp;&nbsp;请描述它的正确性: </template>
        <n-input
