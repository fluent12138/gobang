...
import { NCard, NStatistic, NSpace, NNumberAnimation, NButton, NMessageProvider } from 'naive-ui'
...
export default {
  name: "SelfRecord",
  components: {
    NCard, NStatistic, NSpace, NNumberAnimation, NButton, NMessageProvider
  },
  setup () {
